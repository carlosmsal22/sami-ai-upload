...
st.set_page_config(page_title="Enhanced Persona Generator from PPTX with Avatars", layout="wide")
...
if uploaded_file and st.button("Generate Segmentation Summary"):
    ...
    summary_prompt = f"""You are SAMI AI, an advanced market insights engine. Analyze the following segmentation slides and produce a strategic summary.
...
if st.session_state.summary and st.button("Generate Personas"):
    persona_prompt = f"""Based on this segmentation summary, generate 2-5 distinct personas. Each should include:
- Name
- Description
- Traits
- Pain Points
